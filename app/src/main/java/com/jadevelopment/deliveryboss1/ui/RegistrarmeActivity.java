...
import com.jadevelopment.deliveryboss1.data.api.model.MiDeserializador;
...
public class RegistrarmeActivity extends AppCompatActivity {
    ...
    private void attemptRegister() {
        ...
        if (cancel[0]) {
            ...
            final String[] error = {""};
            Call<ApiResponse> registerCall = mDeliverybossApi.registroNormal(new UsuarioRegisterBody(nombre,apellido,email,contrasenia,imagen,FechaNac,usuario_tipo_idusuario_tipo,sexo_idsexo,usuario_estado_idusuario_estado));
