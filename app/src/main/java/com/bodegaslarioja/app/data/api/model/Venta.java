...
public class Venta {
    ...
    public Venta(String idventa, String fecha_hora, String idbodega, String idcliente, String importe_total, String nota, String nota_bodega, String idventa_tipo, String idventa_estado, String idtipo_entrega, String idusuario_direccion, List<Venta_detalle> venta_detalle) {
    ...
    public String getNota_bodega() {
        return nota_bodega;
    }

    public void setNota_bodega(String nota_bodega) {
        this.nota_bodega = nota_bodega;
    }
}
